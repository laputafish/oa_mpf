  ...
  <yoov-modal id="yoovTimelineSelectionDialog"
    ...
    <div slot="header" class="flex-grow-1 d-flex flex-row">
      ...
      <div class="text-center float-right"
        ...
        <button
          :disabled="selectionInfo.selection.length===0 || booking.description==='' || booking.applicant_name==='' || booking.applicant_id!==user.id"
    ...
    <div slot="body" class="container yoov-modal-body"
      ...
      <div ref="timeSlots" class="time-slots">
        ...
        <table style="width:100%;margin-top:0;">
          <tr>
            <td v-for="(column, index) in timeSlots"
            :key="index">
...
export default {
  ...
  mounted () {
    ...
    let vm = this
    vm.$refs.timeSlots.onselectstart = function () {
      return false
    }
    if (vm.currentMoment) {
