      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title">More complex</h5>
            <form>
              <div class="form-row">
            ...
            <h5 class="card-title">Remix with size-specific column classes</h5>
            <form>
              <div class="form-row align-items-center">
            ...
            <h5 class="card-title">Custom form controls</h5>
            <form>
              <div class="form-row align-items-center">
                <div class="col-auto my-1">
            ...
            <h5 class="card-title">Custom form controls: selects</h5>
            <form class="form-inline">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title">Select menu (resizing)</h5>
            <form>
            ...
            <h5 class="card-title">Select menu (multiple attribute)</h5>
            <form>
            ...
            <h5 class="card-title">Select menu (size attribute)</h5>
            <form>
            ...
            <h5 class="card-title">Range (with min and max)</h5>
            <form>
            ...
            <h5 class="card-title">Range (with step)</h5>
            <form>
